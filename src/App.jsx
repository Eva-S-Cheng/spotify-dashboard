...
export default function App(){
  ...
  return(
    <div className="uc-fade app-root" style={{background:BG,minHeight:"100vh",fontFamily:"'Inter',sans-serif",color:C.txt,padding:"20px 16px 100px",maxWidth:1200,margin:"0 auto"}}>
      {spin}
